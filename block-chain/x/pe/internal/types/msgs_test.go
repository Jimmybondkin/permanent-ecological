...
func TestMsgSetNameGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"pe/SetName","value":{"name":"maTurtle","owner":"cosmos1d4js690r9j","value":"1"}}`
...
func TestMsgBuyNameGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"pe/BuyName","value":{"bid":[{"amount":"10","denom":"atom"}],` +
...
func TestMsgDeleteNameGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"pe/DeleteName","value":{"name":"maTurtle","owner":"cosmos1d4js690r9j"}}`
